...
export class WorkInfoService {
    ...
    private resourceUrl = 'api/work-infos';

    constructor(private http: Http, private dateUtils: JhiDateUtils) { }

    create(workInfo: WorkInfo): Observable<WorkInfo> {
        const copy = this.convert(workInfo);
    ...
    update(workInfo: WorkInfo): Observable<WorkInfo> {
        const copy = this.convert(workInfo);
    ...
    find(id: number): Observable<WorkInfo> {
